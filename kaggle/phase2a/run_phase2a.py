"""
Kaggle kernel script for Phase 2A CAA vector extraction on T4 GPU.
...
def run_phase2a():
    ...
    config_path = "/tmp/nsa/configs/phase2a.qwen3_8b.kaggle_t4.yaml"
...
if __name__ == "__main__":
    ...
    print("=== Running Phase 2A CAA vector extraction ===")
    code = run_phase2a()

    print(f"\n=== Phase 2A finished with exit code {code} ===")
    print("Artifacts written to /kaggle/working/artifacts/phase2a/")
    sys.exit(code)
